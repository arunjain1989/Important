...
angular.module('app.services', [])
    ...
    .factory('utilFactory', function($filter, $rootScope) {

        var factory = {};

        factory.currencyFormat = function(x) {
            x = x.toString();
            var afterPoint = '';
        ...
        factory.numericOnly = function(id) {
            var dotCount = 0;
            var idd = "#" + id;
        ...
        factory.phoneNumeric = function(id) {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    function(position) {
                        ...
                        $rootScope.myLatLong = position.coords.latitude + "," + position.coords.longitude;

                        $rootScope.myCheckInTime = $filter('date')(new Date(), 'yyyy-MM-dd hh:mm:ss');
                        ...
                        $rootScope.showAlert($rootScope.myLatLong + "" + AlertMessages.locationSelected, "" + AlertMessages.alertTitile);
            ...
            function getAddressFromLatLong(lat, long) {
                ...
                geocoder.geocode({
                    ...
                    function(responses) {
                        ...
                        $rootScope.myCheckInAddress = currentAddress;
                    }
                );
            }
        ...
        factory.getDistance = function(addr1, addr2) {
        ...
        factory.getLocationFromAddress = function(address) {
            ...
            geocoder.geocode({
                ...
                if (status == google.maps.GeocoderStatus.OK) {
                    ...
                    var addr = lat + "," + long; // customer address latlong
                    $rootScope.myCustAddrLatLong = addr;


                } else {
                    $rootScope.myCustAddrLatLong = undefined;
        ...
        var changes;
        factory.removeDiacritics = function(str) {
            if (!changes) {
