...
(function() {
    ...
    google.maps.Load = function(apiLoad) {
        ...
        apiLoad([0.009999999776482582, [
                [
                    ["http://mt0.googleapis.com/maps/vt?lyrs=m@367000000\u0026src=api\u0026hl=en-US\u0026", "http://mt1.googleapis.com/maps/vt?lyrs=m@367000000\u0026src=api\u0026hl=en-US\u0026"], null, null, null, null, "m@367000000", ["https://mts0.google.com/maps/vt?lyrs=m@367000000\u0026src=api\u0026hl=en-US\u0026", "https://mts1.google.com/maps/vt?lyrs=m@367000000\u0026src=api\u0026hl=en-US\u0026"]
                ],
                [
                    ["http://khm0.googleapis.com/kh?v=703\u0026hl=en-US\u0026", "http://khm1.googleapis.com/kh?v=703\u0026hl=en-US\u0026"], null, null, null, 1, "703", ["https://khms0.google.com/kh?v=703\u0026hl=en-US\u0026", "https://khms1.google.com/kh?v=703\u0026hl=en-US\u0026"]
                ], null, [
                    ["http://mt0.googleapis.com/maps/vt?lyrs=t@367,r@367000000\u0026src=api\u0026hl=en-US\u0026", "http://mt1.googleapis.com/maps/vt?lyrs=t@367,r@367000000\u0026src=api\u0026hl=en-US\u0026"], null, null, null, null, "t@367,r@367000000", ["https://mts0.google.com/maps/vt?lyrs=t@367,r@367000000\u0026src=api\u0026hl=en-US\u0026", "https://mts1.google.com/maps/vt?lyrs=t@367,r@367000000\u0026src=api\u0026hl=en-US\u0026"]
                ], null, null, [
                    ["http://cbk0.googleapis.com/cbk?", "http://cbk1.googleapis.com/cbk?"]
                ],
                [
                    ["http://khm0.googleapis.com/kh?v=101\u0026hl=en-US\u0026", "http://khm1.googleapis.com/kh?v=101\u0026hl=en-US\u0026"], null, null, null, null, "101", ["https://khms0.google.com/kh?v=101\u0026hl=en-US\u0026", "https://khms1.google.com/kh?v=101\u0026hl=en-US\u0026"]
                ],
                [
                ...
                [
                    ["http://mt0.googleapis.com/maps/vt?hl=en-US\u0026", "http://mt1.googleapis.com/maps/vt?hl=en-US\u0026"]
                ],
                [
            ...
            ["http://maps.googleapis.com/maps-api-v3/api/js/26/11", "3.26.11"],
            [3358547843], 1, null, null, null, null, null, "", null, null, 0, "http://khm.googleapis.com/mz?v=703\u0026", "AIzaSyDMMNEKPI2nBgEFS9XU4WAUi7Qsi2G1ygw", "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "http://mt.googleapis.com/maps/vt/icon", [
                ["http://maps.googleapis.com/maps/vt"],
                ["https://maps.googleapis.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 367000000, 367
            ...
            ["https://www.google.com/maps/api/js/master?pb=!1m2!1u26!2s11!2sen-US!3sUS!4s26/11", "https://www.google.com/maps/api/js/widget?pb=!1m2!1u26!2s11!2sen-US"], null, 0, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, [null, null, null, null, null, null, null, null, null, [0, 0]], null, [],
            ["26.11"]
        ], loadScriptTime);
    };
...
(function(_) {
    'use strict';
    var Ja, Ka, Pa, Sa, jb, pb, qb, rb, sb, wb, xb, Bb, Eb, zb, Fb, Jb, Rb, Xb, Yb, ac, dc, ec, gc, ic, kc, fc, hc, mc, sc, tc, yc, Mc, Oc, Uc, Tc, Vc, Wc, Xc, Yc, Zc, fd, hd, jd, ld, nd, od, Cd, Ed, Dd, Id, Jd, Nd, Rd, Wd, ce, de, ee, se, ue, we, ze, Be, Ae, Ce, He, Ie, Je, Ke, Le, Pe, Qe, Re, Se, Ve, $e, af, bf, cf, df, ef, ff, hf, jf, kf, qf, sf, Cf, Df, Ef, Ff, Gf, Hf, Jf, Kf, Tf, Uf, Vf, $f, bg, kg, lg, sg, qg, tg, ug, yg, Bg, Cg, Gg, Hg, Kg, Lg, Mg, Ng, Og, Ga, Ha;
    _.ba = "ERROR";
    ...
    _.Ib = function(a, b) {
        ...
        return function(d) {
            ...
            var e = {},
                f;
            for (f in d)
                if (e[f] = d[f], !b && !a[f]) throw _.Gb(c + "unknown property " + f);
            for (f in a) try {
                var g = a[f](e[f]);
    ...
    Mg = function(a) {
        for (var b = a.split("."), c = window, d = window, e = 0; e < b.length; e++)
            if (d = c, c = c[b[e]], !c) throw _.Gb(a + " is not a function");
        return function() {
            c.apply(d)
        }
    };
    ...
    _.k.set = function(a, b) {
        ...
        var d = jb(c, a);
        if (d)
            if (a = d.qb, d = d.Kc, c = "set" + _.Db(a), d[c]) d[c](b);
            else d.set(a, b);
        else this[a] = b, c[a] = null, Bb(this, a)
    };
    ...
    var oe = _.Mb(_.Kb(_.me, "google.maps.Data.LinearRing", !0));
    _.t(_.pe, Yb);
    _.k = _.pe.prototype;
    ...
    var ag;
    _.og = "StopIteration" in _.Nc ? _.Nc.StopIteration : {
    ...
    _.xc(ug.prototype, {
        map: _.ei,
        tableId: _.Yg,
        query: _.Qb(_.Ob([_.Wg, _.Nb(_.eb, "not an Object")]))
    });
    _.t(_.vg, _.C);
