...
/* JavaScript content from js/controllers/contactInformationCtrl.js in folder common */
/* JavaScript content from js/controllers/customerInfoCtrl.js in folder common */
FeCreditApp.controller('contactInformationCtrl', function($scope, $location, $rootScope, $ionicNavBarDelegate, $ionicLoading, $timeout, $state) {
    ...
    $scope.$on("$ionicView.enter", function(event, data) {
        ...
        $scope.brotherInLawNumber = Messages.brotherInLawNumber;
        $scope.brotherNumber = Messages.brotherNumber;
        $scope.custFullName = Messages.custFullName;
        $scope.daughterNumber = Messages.daughterNumber;
        $scope.friendNumber = Messages.friendNumber;
        $scope.idCardNumber = Messages.idCardNumber;
        $scope.otherRelative = Messages.otherRelative;
        $scope.sisterNumber = Messages.sisterNumber;
        $scope.sonNumber = Messages.sonNumber;
        $scope.uncleNumber = Messages.uncleNumber;
