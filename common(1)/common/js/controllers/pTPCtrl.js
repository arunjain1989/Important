...
FeCreditApp.controller('pTPCtrl', [ '$scope', '$stateParams', '$ionicPopup','$rootScope','$filter','$state','$ionicLoading', '$ionicScrollDelegate','$exceptionHandler',// The following is
															// the constructor
															// function for this
															// page's
															// controller. See
...
//                                   };
		...
		//contact details click funcation//	
...
//
			...
			$scope.nextCase = function(args, ptpContractList) {
			  $rootScope.ptpIndex =  $rootScope.ptpIndex+args;
			  if ($rootScope.ptpIndex < 0 || $rootScope.ptpIndex >= ptpContractList.length) {
			  	 $rootScope.ptpIndex =  $rootScope.ptpIndex-args;
			  	 return;
			  };
			  if ($rootScope.ptpIndex==0) {
			  	// hide previous button
			  	 $rootScope.previousDiv = false;
			       
			  }else if($rootScope.ptpIndex == ptpContractList.length-1){
