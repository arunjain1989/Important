...
/**
 * Custom ScrollView with Listener
 */
public class Custom_ScrollView extends ScrollView {

    public interface ScrollViewListener {
        void onScrollEnded(Custom_ScrollView scrollView, int x, int y, int oldx, int oldy);
    }
    ...
    public Custom_ScrollView(Context context, AttributeSet attrs, int defStyle) {
