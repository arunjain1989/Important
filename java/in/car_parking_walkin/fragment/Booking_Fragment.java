 ...
 *
 */
public class Booking_Fragment extends Fragment implements View.OnClickListener {
	Context context;
	static FragmentManager fragmentManager;
	Common_Functions com;
	Common_SharedPreference sharedPreference;
	Booking_Fragment thisFragment;
	...
	public View onCreateView(LayoutInflater LayoutInflater, ViewGroup container, Bundle bun)
    {
        ...
        ((LandingPage_Activity)getActivity()).booking_fragment = this;
		...
		if(view ==  null) {
            ...
            getActivity().findViewById(R.id.imgHeaderRight).setVisibility(View.VISIBLE);
...
//                .setMaxDate(com.getMilliSecondsFromDate(currentDay+"/"+(currentMonth+2)+"/"+(currentYear)));
    ...
    public void httpBooking()
    {
        ...
        asyncTaskGet.execute(new Common_Http_Functions(context).walkInCheckIn(com, sharedPreference.readParkingId(),
                strType, strVehicleNo, fixedHrs/*duration*/, strInTime, strOutTime, total, strPaymentStatus));
        asyncTaskGet.setGetDataDownloadListener(new Async_Task_Get.GetDataDownloadListener() {
            ...
            public void dataDownloadedSuccessfully(String response) {
                ...
                System.out.println("BOOKING - JSON RESPONSE : " + response);
                try {
...
//                        }
                        ...
                        String refNo = jsonObject.getString("QRCodeNumber");

                        bookingPopup(msg, QRCode, refNo);
    ...
    public void bookingPopup(String msg, String QRCode, String refNo)
    {
        ...
        dialog.findViewById(R.id.img_BookingPopup_closeright).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                LandingPage_Activity.changing_Fragment(fragmentManager, new Home_Fragment());
            }
        });
